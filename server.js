...
function buildPrompt({ notes, pose, garmentAnalysis, seriesPose }) {
  ...
  const poseLine = seriesPose
    ...
    : {
    "quiet-luxury":
      `竖版全身，模特姿态松弛自信，重心放在后腿，一只手自然垂放。场景：${sceneMap["quiet-luxury"]}。`,
    "walking":
      `竖版全身，模特在街上自然行走，步伐轻盈放松，一只手插口袋，抓拍感。场景：${sceneMap["walking"]}。`,
    "studio-clean":
      `竖版全身，模特正对镜头站立，双手自然垂放，展示服装完整廓形。场景：${sceneMap["studio-clean"]}。`,
    "detail-forward":
      `竖版大半身，重点展示领口、袖口、口袋和门襟的做工细节。场景：${sceneMap["detail-forward"]}。`,
  }[pose] || "竖版全身，高级电商模特感。";
  ...
  return [
    ...
    "内搭（如果主商品是外套）：白色重磅真丝衬衫或极细羊绒高领打底衫，面料有明显的高级光泽和肌理。",
    "下装：黑色直筒西裤，羊毛混纺面料，垂坠感极好，裤线锋利，裤长刚好盖住鞋面。",
    "鞋子：黑色方头短靴或黑色尖头小猫跟，皮质细腻。",
    "配饰：腕间极细的银色手表或手链，除此之外不加多余配饰。不戴墨镜。",
    "",
    "服装细节（根据上传图片自动解析）：",
